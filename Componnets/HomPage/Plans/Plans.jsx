    ...
    return (
        <div className='bg-[#F5F5F5]'>
            <section className="container mx-auto px-4 " id="plans">
              ...
              ${plan.featured
                                        ? "bg-white border-2 border-[#a15f43] shadow-lg scale-105"
                                        : "bg-[#fdfaf7] border border-[#eadfd6] hover:shadow-md"
                                    }`}
                            >

                                {/* Badge */}
                                {plan.featured && (
                                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#9c5b3f]
                                     text-white px-5 py-1 rounded-full text-xs tracking-widest uppercase">
                                        What We Do
                                    </div>
                                )}
                                ...
                                {plan.featured && (
                                    <a
                                        ...
                                        className="block text-center mt-10 w-full py-3 rounded-full transition 
