    ...
    return (
        <div className='bg-[#F5F5F5]'>
            ...
            flex flex-col h-full'>
                            ...
                            <h3 className='text-[#8B5E3C] font-medium p-2 text-lg font-serif'>{programes.title}</h3>
                            <p className='text-[#7A7A7A] p-2 text-xs'>{programes.description}</p>
                            <button className='p-2 text-sm font-bold flex items-center gap-2
